...
//var huts_button = document.querySelector(".right-nav-huts-filter");
//var campsites_button = document.querySelector(".right-nav-campsites-filter");
//var caves_button = document.querySelector(".right-nav-caves-filter");
//var waterfalls_button = document.querySelector(".right-nav-waterfalls-filter");
//var paths_button = document.querySelector(".right-nav-paths-filter");
//var add_button = document.querySelector(".right-nav-add-tool");
//var search_button = document.querySelector(".right-nav-search-tool");
...
//  app.eventsHandler.addFormDropdownListener()
//  app.showMainWindow()
//})
//